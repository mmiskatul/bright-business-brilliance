...
import { Star, CheckCircle2, ChevronDown, ArrowRight, X } from "lucide-react";
...
const initialReviews: ReviewItem[] = [
  ...
  {
    id: "rev-4",
    title: "Master Quality Sublimation & Finish",
    rating: 5,
    date: "Sep 15, 2023",
    comment:
...
export default function ReviewsPage() {
  ...
  const handleReviewSubmit = (e: React.FormEvent) => {
    ...
    const newRev: ReviewItem = {
      id: `rev-${Date.now()}`,
      title: formTitle.trim() || "Outstanding Quality & Matchday Fit",
      rating: formRating,
      date: "Just now",
  ...
  return (
    <div className="bg-white text-neutral-900 selection:bg-neutral-900 selection:text-white">
      {/* ─── SECTION 1: HERO HEADER & SCORE CARD ────────────────── */}
      <section className="py-14 sm:py-20 lg:py-24 border-b border-neutral-100 text-center bg-white">
        <div className="container-page max-w-4xl">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight uppercase text-neutral-900 leading-[1.08]">
            WHAT THE SQUAD SAYS:
            <br />
            <span className="text-[#047857]">PERFORMANCE VERIFIED</span>
          </h1>

          <p className="mt-4 text-xs sm:text-sm text-neutral-500 max-w-xl mx-auto leading-relaxed">
            Don't just take our word for it. See how ASFA Design / Apex Athletic gear performs on
            the pitch, court, and track, backed by thousands of athletes worldwide.
          </p>

          {/* Rating Summary Card */}
          <div className="mt-10 mx-auto max-w-lg border border-neutral-200 bg-[#F4F5F4] p-6 sm:p-8 text-left flex flex-col sm:flex-row items-center justify-between gap-8">
            {/* Left: Overall Score */}
            <div className="text-center sm:text-left shrink-0">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-1 text-[#047857] mt-1.5">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="h-4 w-4 fill-current text-[#047857]" />
                ))}
              </div>
            ...
            <div className="w-full sm:w-60 space-y-3 font-mono text-xs">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-neutral-300 overflow-hidden rounded-xs">
        ...
        <div className="container-page max-w-6xl">
          ...
          <div className="flex items-center justify-between pb-8">
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="Verified Orders">Verified Orders</option>
              </select>
          ...
          <div className="grid gap-6 md:grid-cols-3 items-start">
            {reviews.slice(0, displayCount).map((rev) => (
              <div
                key={rev.id}
                className="flex flex-col justify-between border border-neutral-200 bg-white transition-all hover:border-neutral-300 hover:shadow-2xs overflow-hidden"
              >
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-0.5 text-[#047857]">
                        {[...Array(rev.rating)].map((_, i) => (
                          <Star key={i} className="h-3.5 w-3.5 fill-current text-[#047857]" />
                        ))}
                      </div>
                    ...
                    {/* Review Body */}
                    <p className="mt-2 text-xs text-neutral-500 leading-relaxed font-normal">
                      "{rev.comment}"
                    </p>
                  </div>

                  {/* Author / Verification Footer */}
                  <div className="mt-6 border-t border-neutral-100 pt-4 flex items-center gap-2.5">
      ...
      {/* ─── SECTION 3: SHARE YOUR STATS ────────────────────────── */}
      <section className="py-16 sm:py-24 bg-[#EFEFEF] text-center">
        <div className="container-page max-w-3xl">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black uppercase text-neutral-900 tracking-tight">
            SHARE YOUR STATS
          </h2>

          <p className="mt-3 text-xs sm:text-sm text-neutral-500 max-w-lg mx-auto leading-relaxed">
          ...
          <div className="mt-6">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#047857] hover:bg-[#065F46] text-white font-mono text-xs font-bold uppercase tracking-wider py-3.5 px-6 shadow-2xs transition-colors cursor-pointer"
            >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in">
          <div className="relative w-full max-w-lg border border-neutral-300 bg-white p-6 sm:p-8 shadow-2xl">
            <button
              ...
              className="absolute top-4 right-4 p-1 text-neutral-400 hover:text-neutral-900 transition-colors cursor-pointer"
            >
              <X className="h-5 w-5" />
            </button>
            ...
            <form onSubmit={handleReviewSubmit} className="mt-6 space-y-4 font-mono text-xs">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-neutral-300 bg-[#FAFAF8] px-3.5 py-2 text-xs text-neutral-900 outline-none focus:border-black focus:bg-white resize-y"
                />
              </div>
              ...
              <div className="pt-2 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="border border-neutral-300 bg-white px-4 py-2 text-xs font-bold text-neutral-700 hover:bg-neutral-50 cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="bg-[#047857] hover:bg-[#065F46] text-white px-5 py-2 text-xs font-bold uppercase cursor-pointer"
                >
                  Publish Review
                </button>
              </div>
